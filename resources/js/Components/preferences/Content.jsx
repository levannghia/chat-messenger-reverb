...
import { BsAppIndicator, BsBan, BsBoxArrowRight, BsChevronDown, BsChevronRight, BsCircleHalf, BsKey, BsPersonCircle } from 'react-icons/bs';
      ...
      <div className="flex h-full max-h-[calc(100vh_-_106px)] flex-col gap-2 overflow-x-auto p-2">
        ...
        <div className="flex justify-between">
          ...
          >
            ...
            <span
              className={`${auth.active_status ? "translate-x-6" : "translate-x-1"
